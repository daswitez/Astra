...
create policy "members can read flowcharts"
on public.flowcharts for select
using (public.is_workspace_member(workspace_id));

create policy "members can write flowcharts"
on public.flowcharts for all
using (public.is_workspace_member(workspace_id))
with check (public.is_workspace_member(workspace_id));
...
create policy "members can write whiteboards"
