      ...
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/[0.03] p-8 shadow-[0_30px_100px_rgba(0,0,0,0.45)]">
        <div className="mb-8 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-white/40">Get started with Astra</p>
          </div>
        </div>
        ...
        {sent && (
          <div className="mb-5 rounded-xl border border-emerald-400/20 bg-emerald-400/10 p-4 text-sm text-emerald-100">
            Check your email to confirm your account, then you&apos;ll be redirected to set up Astra.
          </div>
        )}
        ...
        <form action={signUp.bind(null, locale)} className="space-y-4">
        ...
        <p className="mt-6 text-center text-sm text-white/40">
          ...
          <Link href="/login" locale={locale} className="text-white/70 hover:text-white transition-colors underline underline-offset-2">
            Sign in
          </Link>
        </p>
      </div>
